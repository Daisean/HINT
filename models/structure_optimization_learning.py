...
class SOL(nn.Module):
    def __init__(self, depth, num_mlp_layers, input_dim, hidden_dim, output_dim, final_dropout, tree_pooling_type, neighbor_pooling_type, device):
        '''
    ...
    def __preprocess_neighbors_maxpool(self, batch_tree):
        ...
        # compute the maximum number of neighbors within the trees in the current minibatch
    ...
    def __preprocess_neighbors_sumavepool(self, batch_tree):
        ...
        for layer in range(1, self.depth+1):
            ...
            Adj_block = torch.sparse.FloatTensor(Adj_block_idx, Adj_block_elem, torch.Size([start_idx[-1], start_pdx[-1]]))
